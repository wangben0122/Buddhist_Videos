...
public class SystemBarHelper {
    ...
    public static void setStatusBarDarkMode(Activity activity) {
        setStatusBarDarkMode(activity.getWindow(),activity);
    }

    /** 设置状态栏darkMode,字体颜色及icon变黑(目前支持MIUI6以上,Flyme4以上,Android M以上) */
    public static void setStatusBarDarkMode(Window window,Activity activity) {
        if (isFlyme4Later()) {
          ...
          tintStatusBar(activity,activity. getResources().getColor(R.color.translucence), 0);
        }
    }
    ...
    public static boolean isFlyme4Later() {
        return Build.FINGERPRINT.contains("Meizu")
                || Build.VERSION.INCREMENTAL.contains("Meizu")
