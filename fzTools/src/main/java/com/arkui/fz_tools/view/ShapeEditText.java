...
public class ShapeEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getDimension(R.styleable.ShapeEditText_radius, 0);
        stroke = typedArray.getDimension(R.styleable.ShapeEditText_stroke, 0);
        colors = typedArray.getColorStateList(R.styleable.ShapeEditText_buttonColor);
