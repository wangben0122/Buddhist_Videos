 ...
 */
public class AssetDecoration extends RecyclerView.ItemDecoration {
    ...
    public AssetDecoration(Context context, int orientation) {
    ...
    public AssetDecoration(Context context, int orientation, int drawable) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (i == parent.getAdapter().getItemCount() - 1) {
                ...
                if (i == 0) {
                    mDivider.setBounds(left, bottom * 10, right, bottom);
                    mDivider.draw(c);
                } else {
