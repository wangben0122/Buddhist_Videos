package com.arkui.fz_tools.dialog.old.bottom;
...
import com.arkui.fz_tools.dialog.old.entity.DialogMenuItem;
import com.arkui.fz_tools.dialog.old.listener.OnOpenItemClickL;
...
public class ActionSheetDialog extends BaseDialog {
     ...
     */
    private int mCancelTextColor = Color.parseColor("#333333");
    /**
    ...
    private OnOpenItemClickL mOnOpenItemClick;
     ...
     * @param
     */
    public void setOnOpenItemClick(OnOpenItemClickL onOpenItemClick) {
        this.mOnOpenItemClick = onOpenItemClick;
    }
     ...
     */
    public ActionSheetDialog widthScale(float widthScale) {
