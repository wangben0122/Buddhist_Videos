   ...
   /* DisplayImageOptions options;
    ...
    public class LocalViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int position) {
            ...
            //ImageLoader.getInstance().displayImage(paths.get(position), new ImageViewAware(imageView), localOptions, loadingListenerr);
            imageView.setImageResource(R.mipmap.zc_photo);
            return imageLayout;
        }
