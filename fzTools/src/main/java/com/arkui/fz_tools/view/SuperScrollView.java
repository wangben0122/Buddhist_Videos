            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shouldMove) {
                    ...
                    isMoved = true; // 记录移动了布局
                     //LogUtil.e("X==" + nowY + "Y==" + deltaY + "offset" + offset+"originalRect"+originalRect.bottom);
                    if (onPullUpListener != null) {
                      //  if (deltaY < -150) {
                            onPullUpListener.OnPullMove();
                     //   }
