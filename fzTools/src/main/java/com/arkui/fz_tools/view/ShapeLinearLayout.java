...
public class ShapeLinearLayout extends LinearLayout {
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getDimension(R.styleable.ShapeLinearLayout_radius, 0);
        stroke = typedArray.getDimension(R.styleable.ShapeLinearLayout_stroke, 0);
        colors = typedArray.getColorStateList(R.styleable.ShapeLinearLayout_buttonColor);
