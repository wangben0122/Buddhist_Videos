package com.arkui.fz_tools.wheelview;
...
import com.arkui.fz_tools.wheelview.utils.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected int topBackgroundColor = 0xffebebeb;
 //   protected int topBackgroundColor = Color.WHITE;
    protected boolean cancelVisible = true;
    protected CharSequence cancelText = "";
    protected CharSequence submitText = "";
    protected CharSequence titleText = "";
    protected int cancelTextColor = 0xff0294DD;
    protected int submitTextColor = 0xff0294DD;
...
//    protected int submitTextColor = Color.BLACK;
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, ConvertUtils.toPx(activity, 50)));
