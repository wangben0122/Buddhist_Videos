...
public class WheelView extends ScrollView {
     ...
     */
    public static final int TEXT_COLOR_FOCUS = 0XFF0294DD;
    /**
     ...
     */
    public  final int LINE_COLOR = 0XFFD1D1D1;
    /**
    ...
    private TextView createView(String item) {
        ...
        int paddingLR = dip2px(15);
        int paddingTB = dip2px(8);
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                canvas.drawLine(0, areaBorder[0], viewWidth * 5* 6, areaBorder[0], paint);
                canvas.drawLine(0, areaBorder[1], viewWidth * 5 *6, areaBorder[1], paint);
            }
