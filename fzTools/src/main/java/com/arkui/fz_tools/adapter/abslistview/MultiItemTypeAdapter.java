...
import com.arkui.fz_tools.adapter.abslistview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListViewHolder listViewHolder = ListViewHolder.get(mContext, convertView, parent,
                layoutId, position);
