...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int SHADOW_COLOR =0xEEEEEE;
    ...
    private void init(final Context context, final AttributeSet attrs) {
       ...
       // mFillPaint.setColor(ContextCompat.getColor(context,R.color.mainColor));
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f,0xffeeeeee, 0xffeeeeee, Shader.TileMode.CLAMP));
