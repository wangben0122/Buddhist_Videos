...
public class ShapeTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getDimension(R.styleable.ShapeTextView_radius, 0);
        stroke = typedArray.getDimension(R.styleable.ShapeTextView_stroke, 0);
        colors = typedArray.getColorStateList(R.styleable.ShapeTextView_buttonColor);
