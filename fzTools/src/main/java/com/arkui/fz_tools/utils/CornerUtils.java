...
public class CornerUtils {
    ...
    public static Drawable cornerDrawable(final int bgColor, float topLeft,float topRight,float bottomLeft,float bottomRight) {
        final GradientDrawable bg = new GradientDrawable();
        bg.setCornerRadii(new float[]{topLeft, topLeft, topRight, topRight, bottomRight, bottomRight,  bottomLeft,  bottomLeft});
        bg.setColor(bgColor);
        return bg;
    }
