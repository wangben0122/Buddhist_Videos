...
public class FileUtils {
     ...
     * 文件缓存根目录
     */
    public static final String CACHEDIR = "hhzn/newDoctor";
    /**
     * 图片
     */
    ...
    public static String createRootPath() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            cacheRootPath = App.getContext().getExternalCacheDir().getPath();
        } else {
            // /data/data/<application package>/cache
            cacheRootPath = App.getContext().getCacheDir().getPath();
        }
